...
public:
    ...
    virtual float eval(float x, float y) {
        return static_cast<float>(cos(PI * arg->eval(x,y)));
    }
...
public:
    ...
    virtual float eval(float x, float y) {
        return static_cast<float>(sin(PI * arg->eval(x,y)));
    }
...
public:
    ...
    virtual float eval(float x, float y) {
        return static_cast<float>(tanh(PI * arg->eval(x,y)));
    }
...
public:
    ...
    virtual float eval(float x, float y) {
        return static_cast<float>(1.0 - arg->eval(x,y));
    }
